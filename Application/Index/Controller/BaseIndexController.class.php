...
use Common\Service\FriendlyLinkService;
...
class BaseIndexController extends Controller {
    ...
    /**
     * @var FriendlyLinkService 友情链接服务
     */
    private $friendlyLinkService;
    ...
    function __construct() {
        ...
        // 获取友情链接
        $this->commonOutput['common']['friendlyLinkList'] = $this->getFriendlyLink();
        // 通用标题后缀
    ...
    public function getFriendlyLink() {
        $this->friendlyLinkService = new FriendlyLinkService();
        $param['where'] = $this->getCommonShowDataSelectParam();
        $friendlyLinkList = $this->friendlyLinkService->getList($param);
