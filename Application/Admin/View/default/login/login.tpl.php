...
<cite>
    ...
    <script type="text/javascript" src="/public/static/vendor/js/jquery.spritely/0.6.8/jquery.spritely-0.6.8.js"></script><!-- 云层效果 -->
    <script type="text/javascript">
        $(function () {
            ...
            var $bgArr = [
                ...
                '<?php echo TPL;?>/image/login/login-bg-4.jpg',
